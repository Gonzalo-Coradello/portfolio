        ...
        <>
            ...
            <section className='max-w-[1200px] mx-auto px-10'>
                <div>
                    <div className='flex flex-col md:flex-row gap-12 justify-center items-center md:gap-24 my-20'>
                        <div className='basis-1/6 flex gap-16 md:gap-6 md:flex-col'>
                            <div className='rounded-full aspect-square overflow-hidden w-3/4 mx-auto md:w-full'>
                                <img src={Photo} alt='' className='object-cover h-full max-h-[400px] grayscale hover:grayscale-0 hover:scale-110 transition-all duration-500' />
                            </div>
                        ...
                        <div>
                            <p className='text-left md:max-w-[30ch] font-light'>Soy un desarrollador Full-Stack disponible para trabajos de tiempo completo, medio tiempo y proyectos freelance.</p>
                    ...
                    <div className='text-justify font-light w-fit mx-auto mb-12'>
                        <h2 className='text-2xl font-medium mb-4'>Sobre mí</h2>
                        <div className='grid gap-4 py-6 px-4 bg-white/10 backdrop-blur-sm rounded-lg shadow-md md:py-12 md:px-8'>
                            <p className='md:max-w-[60ch]'>Soy Gonzalo Coradello, desarrollador web orientado al Front-End. Tengo 23 años y vivo en Pergamino, Buenos Aires. Soy profesor de música y técnico multimedial. Los últimos años estuve trabajando como docente mientras avanzaba con la carrera.</p>
                            <p className='md:max-w-[60ch]'>Siempre amé la tecnología. Descubrí la programación hace poco tiempo y me enamoré de las amplias posibilidades que brinda este campo. Empecé a programar en abril del 2022 y desde entonces me esfuerzo cada día por mejorar, aprendiendo nuevas tecnologías, mejorando mis habilidades y creando proyectos. Tengo claro que mi objetivo es dedicarme a la programación a nivel profesional.</p>
                            <p className='md:max-w-[60ch]'>Me apasiona aprender, crear soluciones y hacer realidad proyectos.</p>
                        </div>
