        ...
        <footer className='md:pb-4'>
            <div className="md:w-[80%] mx-auto grid items-center lg:grid-cols-3 gap-8 py-10 px-8 bg-white/20 backdrop-blur-sm rounded-lg shadow-xl mt-12">
                ...
                <div className='w-fit mx-auto text-md lg:order-3'>
                    <h4>Diseño: <a className='footer-gradient hover:opacity-70 transition-opacity duration-500' href="https://www.linkedin.com/in/talia-laborde/" target="_blank" rel="noopener noreferrer">Talia Laborde</a></h4>
                    <h4>Ilustración: <a className='footer-gradient hover:opacity-70 transition-opacity duration-500' href='https://www.instagram.com/wiwadd/' target="_blank" rel="noopener noreferrer">wiwadd</a></h4>
                </div>
            </div>
        </footer>
    )
